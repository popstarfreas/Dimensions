...
class Player {
	...
	public setItem(item: Item): void {
		...
		let playerInventorySlot = new PacketWriter(10)
	  ...
	  public setLife(life: number): void {
		...
		let playerLife = new PacketWriter(8)
	...
	public setMana(mana: number): void {
		...
		let playerMana = new PacketWriter(8)
	...
	public setVisuals(): void {
		...
		let playerInfo = new PacketWriter(32 + getPackedStringByteLen(this.name))
