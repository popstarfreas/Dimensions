...
class BufferReader {
    ...
    public readString(): string {
        ...
        const strContent: string = utf8.decode(hex2a(this._data.slice(this.head, this.head + strLength).toString("hex")));
        this.head += strLength;
        return strContent;
    }
