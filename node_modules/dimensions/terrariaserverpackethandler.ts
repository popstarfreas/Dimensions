...
class TerrariaServerPacketHandler {
  ...
  private handleContinueConnecting(packet: Packet): boolean {
    ...
    const packetData = new PacketWriter(21)
  ...
  private handleWorldInfo(packet: Packet): boolean {
    ...
    if (this.currentServer.client.state === ClientState.ConnectionSwitchEstablished) {
      ...
      let getSection = new PacketWriter(11)
      ...
      if (this.currentServer.client.routingInformation !== null) {
        ...
        let dimensionsUpdate = new PacketWriter(5 + strLen)
          .setType(PacketTypes.DimensionsUpdate)
  ...
  private handleCompleteConnectionAndSpawn(packet: Packet): boolean {
    if (this.currentServer.client.state === ClientState.FinalisingSwitch) {
      ...
      let spawnPlayer = new PacketWriter(8)
