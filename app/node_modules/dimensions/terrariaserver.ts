    ...
    try {
      ...
      if (this.client.options.log.tServerError) {
        if (this.client.options.log.outputToConsole) {
          console.log(`TS Handle Data Error: ${ErrorHelper.toMessage(e)}`);
        }

        this.client.logging.appendLine(`TS Handle Data Error: ${ErrorHelper.toMessage(e)}`);
      }
    }
  }
  ...
  public handleClose(): void {
    ...
    try {
      ...
      if (this.client.options.log.tServerError) {
        ...
        this.client.logging.appendLine(`handleClose ERROR: ${ErrorHelper.toMessage(e)}`);
      }
    }
