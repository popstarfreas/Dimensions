...
class TerrariaServerPacketHandler {
  ...
  private handleContinueConnecting(packet: Packet): boolean {
    ...
    const dimensionPacket = {
      packetType: PacketTypes.DimensionsUpdate,
      data: packetData
    };
    this.currentServer.getPacketHandler().handlePacket(this.currentServer, dimensionPacket);
    this.currentServer.socket.write(dimensionPacket.data);
