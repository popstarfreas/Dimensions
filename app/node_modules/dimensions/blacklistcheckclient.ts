...
class BlacklistCheckClient {
    ...
    private clientAcceptedCb!: (packetsReceived: RawPacket[]) => void;
    private clientBlacklistedCb!: () => void;
    private errorCheckingBlacklistCb!: (packetsReceived: RawPacket[], e: Error) => void;
            ...
            case "ClientUuid":
                ...
                this.settings.blacklist.checkInformation(this.name, ip, clientUuid.uuid).then((isBlacklisted) => {
                    ...
                    if (isBlacklisted) {
                        ...
                        this.clientAcceptedCb(this.packetsReceived);
                    }
                }).catch((e) => {
                    if (this.disposed) {
                        return;
                    ...
                    this.dispose()
                    this.errorCheckingBlacklistCb(this.packetsReceived, e)
                })
                break;
        }
    }
