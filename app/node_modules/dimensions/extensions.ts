...
class Extensions {
    ...
    public static loadExtensions(extensionsList: Dictionary<Extension>, listenServers: { [name: string]: ListenServer }, options: LogOptions, logging: winston.Logger, storageMap: Map<string, any>) {
        try {
