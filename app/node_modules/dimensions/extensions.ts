...
class Extensions {
    ...
    public static loadExtensions(extensionsList: Dictionary<Extension>, listenServers: { [name: string]: ListenServer }, options: LogOptions, logging: Logger) {
        try {
