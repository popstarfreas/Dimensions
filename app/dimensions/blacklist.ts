...
class Blacklist {
     ...
     */
    private parseResponse(data: string, resolve: (value: boolean) => void, reject: (error: unknown) => void): void {
        let resDetails: BlacklistResponse;
        try {
